...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            ...
            case "final": titulo = "21 de Outubro de 2022"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>O dia em que ela disse<br><span class='letra2 letra-vermelha'>SIM</span></strong></p></section>";break;
        }
